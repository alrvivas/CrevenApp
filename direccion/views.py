...
from .forms import BillingShippingForm
from direccion.models import Address
from orden.models import Order,OrderExtraInfo
from util.address import assign_address_to_request, get_billing_address_from_request, get_shipping_address_from_request
from util.cart import get_or_create_cart
from util.order import add_order_to_request, get_order_from_request
from django.views.generic import TemplateView, View
from util.login_mixin import LoginMixin


class CheckoutSelectionView(LoginMixin, TemplateView):
    ...
    def _get_dynamic_form_class_from_factory(self):
        ...
        form_class = model_forms.modelform_factory(
            Address, exclude=['user_shipping', 'user_billing'])
        return form_class
...
class ThankYouView(LoginMixin, TemplateView):
...
class ShippingBackendRedirectView(LoginMixin, View):
...
class PaymentBackendRedirectView(LoginMixin, View):
    def get(self, *args, **kwargs):
        try:

...
from order_signals import processing
...
class ProductStatisticsManager(models.Manager):
    ...
    def top_selling_products(self, quantity):
        ...
        from orden.models import OrderItem
...
class OrderManager(models.Manager):
    ...
    def create_order_object(self, cart, request):
        ...
        order.order_total = cart.total_peso
        return order
    ...
    def create_from_cart(self, cart, request):
        ...
        from .models import ExtraOrderItemPriceField, ExtraOrderPriceField, OrderItem
        ...
        for item in cart_items:
            ...
            order_item.line_totalpeso       = item.line_totalpeso
            order_item.line_subtotalpeso    = item.line_subtotalpeso
            order_item.save()

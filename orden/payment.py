...
from util.decorators import on_method, shop_login_required, order_required


class ExamplePayment(object):
    backend_name = "Efectivo"
    backend_verbose_name = _("Efectivo")
    url_namespace = "pego-efectivo"

    def __init__(self, shop):
        self.shop = shop
        self.template = 'example_payment.html'
    ...
    def get_urls(self):
        urlpatterns = patterns('',
            url(r'^$', self.show_payment, name='pego-efectivo'),
            url(r'^$', self.process_payment, name='procesando-pago'),
        )
        return urlpatterns
